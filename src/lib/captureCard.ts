...
export async function captureCardAsImage(data: CardCaptureData): Promise<void> {
  ...
  if (data.agendamento)
    rows.push(row(SVG.calendarCheck, "Agendamento", data.agendamento, { highlight: true }));
