...
export function WhatsAppInbox({ leads = [] }: { leads?: Lead[] }) {
  ...
  useEffect(() => {
    ...
    loadChats(true);
    // Consulta incremental: depois da primeira carga, só chats alterados geram leitura.
        ...
        <div className="flex-1 min-h-0 overflow-y-auto max-h-[590px]">
          ...
          {!filteredChats.length && (
            <div className="p-8 text-center text-sm text-muted-foreground">
              ...
              Nenhuma conversa comercial nova registrada ainda.
            </div>
          )}
        </div>
      </div>
