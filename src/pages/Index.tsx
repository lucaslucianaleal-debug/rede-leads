...
const CRMDashboard = () => {
  const { user, currentClinic, setSelectedClinic, clinicMeta, userProfile } = useAuth();
  ...
  const isCorretorModule = userProfile?.accountModule === "corretor"
    || clinicMeta?.module === "corretor"
    || currentClinicRecord?.module === "corretor";
