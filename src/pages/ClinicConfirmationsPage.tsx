...
import { ClinicFinanceDailyUpdateGuard } from "@/components/crm/ClinicFinanceDailyUpdateGuard";
  ...
  return <div className="min-h-screen bg-background">
    ...
    <main className="mx-auto max-w-[1400px] px-4 py-6 sm:px-6">
      ...
      {mainSection === "finance" && <div className="space-y-4">
        ...
        {financeView === "today" && <><ClinicFinanceDailyUpdateGuard onOpenData={() => setFinanceView("data")} /><ClinicFinanceDailyDesk /></>}{financeView === "recovery" && <ClinicFinanceRecoveryCenterV2 salesItems={salesItems} />}{financeView === "data" && <div className="space-y-4"><div className="rounded-xl border border-blue-200 bg-blue-50/40 px-4 py-3 text-sm text-blue-900">Área administrativa. Atualize diariamente <b>Contas a receber</b>, <b>Vendas</b> e <b>Recebimentos</b> antes de iniciar as cobranças. O trabalho diário fica em <b>Hoje</b> e <b>Recuperação</b>.</div><ClinicSalesImportPanel onImported={(items) => setSalesItems(items)} /><ClinicFinancePersistentDashboard salesItems={salesItems} /></div>}
